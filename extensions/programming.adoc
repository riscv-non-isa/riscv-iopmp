...
configure additional MDs for different settings in MDCFG Table and entry array, and switch the associated MDs for an RRID in the SRCMD table from a single access.
