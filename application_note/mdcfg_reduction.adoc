...
[NOTE]
====
_k_ * `HWCFG0.md_num` can be greater than `HWCFG1.entry_num`. Behavior of any entry with index &#8805; `HWCFG1.entry_num` is described on <<#IOPMP_ENTRY, IOPMP Entry and IOPMP Entry Array>>.
====
